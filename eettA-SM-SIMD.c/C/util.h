...
typedef double vectortype __attribute__ ((__vector_size__ (16*nsse),
				       __may_alias__));
...
//HelType can be set to vectortype directly
typedef v2complex HelType;
...
//Vec is of type v2complex. .v is vectortype component.
//Is redundant and can be eliminated. 
#define Vec(x,y,i) ves(x,y,i).v
