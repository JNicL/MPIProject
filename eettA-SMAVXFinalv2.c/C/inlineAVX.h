...
int num_hels; // Is the number of helcity combinations divided by 2!
hel_comb *helcomb;

inline int2 Spinor_AVX(int i, int s, int d, int N){
	int2 ret;
	//mmset was buggy for Chain functions, seemed to work here,  dunno why this problem arise.
	/*ret.v =*/
...
/*void cmultInlineASM(__m256d *a, __m256d *b, __m256d *c){*/
/*asm */
/*(*/
/*"vmovupd (%2),%%ymm1;"*/
/*"vmovupd (%2), %%ymm2;"*/
...
inline __m256d cmultIntrinsic(__m256d *a, __m256d *b){
...
inline v2complex cmult_AVX(v2complex a,v2complex b){
	v2complex ret;
	ret.v2 = cmultIntrinsic((__m256d *)&a,(__m256d *)&b);
	return ret;
}

inline __m256d cmult(__m256d a,__m256d b){
	return  cmultIntrinsic(&a,&b);
}
...
static double sumup(ComplexType CCloop,ComplexType CCtree) {
